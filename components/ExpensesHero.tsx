...
const ExpensesHero = () => {
  return (
    <section className="relative flex flex-col md:flex-row items-center max-sm:justify-center justify-between px-5 md:px-20 bg-gradient-to-b from-purple-500 to-white min-h-screen">
      <div className="relative w-full md:w-1/2 flex max-md:hidden justify-start order-1 md:order-none mb-10 md:mb-0">
