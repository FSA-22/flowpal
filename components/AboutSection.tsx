  ...
  return (
    <section id="about" className="w-full bg-white flex flex-col gap-16">
      ...
      <div className="flex max-sm:flex-col max-w-7xl mx-auto md:px-25 md:mt-20 md:flex-row items-center justify-between gap-20 w-full">
        ...
        <div className="max-sm:w-full max-sm:px-5 md:w-1/2 flex flex-col max-sm:items-center gap-6">
      ...
      <div className="w-full bg-[#e6a7ff9a] py-16 px-6 md:py-20 md:px-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start justify-between gap-12 relative z-10">
          ...
          <div className="relative w-full md:w-1/2 flex justify-end">
            <div className="relative max-sm:mx-auto max-md:mx-auto w-64 h-64 md:w-90 md:h-90 rounded-full overflow-hidden shadow-lg">
              <Image
                src="/chooseus.jpg"
                alt="Why Choose Us"
                fill
            ...
            <div className="absolute max-sm:hidden max-md:hidden z-0 top-0 -right-3 h-[360px] w-[383px] -rotate-30 border-1 border-[#bb48e8] rounded-full" />
          </div>
        </div>
      </div>
    </section>
